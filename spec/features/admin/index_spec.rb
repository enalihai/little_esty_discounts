...
RSpec.describe "Admin Dashboard" do
  ...
  it 'the ids are sorted by least recent' do
    ...
    InvoiceItem.create!(invoice_id: invoice_1.id, item_id: item_1.id, quantity: 1, unit_price: 100, status: 1)
    InvoiceItem.create!(invoice_id: invoice_2.id, item_id: item_2.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_3.id, item_id: item_3.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_4.id, item_id: item_4.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_5.id, item_id: item_5.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_6.id, item_id: item_6.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_7.id, item_id: item_7.id, quantity: 1, unit_price: 100, status: 1)
    InvoiceItem.create!(invoice_id: invoice_8.id, item_id: item_8.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_9.id, item_id: item_9.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_10.id, item_id: item_10.id, quantity: 1, unit_price: 100, status: 0)
    InvoiceItem.create!(invoice_id: invoice_11.id, item_id: item_11.id, quantity: 1, unit_price: 100, status: 0)
